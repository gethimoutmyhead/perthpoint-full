...
<div class="wrap" id="wpbackitup-settings">
  ...
  <div id="content">
      ...
      <div class="widget">
        ...
        <p><?php _e('Many hosts limit the amount of space that you can take up on their servers. This option tells WPBackItUp the maximum number of backup archives that should remain on your hosts server.  Doactionn\'t worry, we will always remove the oldest backup archives first.', 'wp-backitup') ?></p>
