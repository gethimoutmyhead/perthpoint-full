...
<item>
        ...
        <media:content url="<?php $postID = $eventsThisWeek->id(); $thumbID = get_post_thumbnail_id($postID); echo wp_get_attachment_image_src($thumbID,'thumbnail-size', true)[0];?>" medium="image" />
        <?php rss_enclosure(); ?>
