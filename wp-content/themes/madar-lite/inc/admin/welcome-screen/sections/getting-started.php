...
<div id="getting_started" class="madar-lite-tab-pane active">
	...
	<div class="madar-tab-pane-center">
		...
		<p><a href="<?php echo esc_url( 'https://retina-theme.com/how-to-install-madar-lite-theme/' ); ?>" class="button button-primary"><?php esc_html_e( 'Read full documentation', 'madar-lite' ); ?></a></p>
