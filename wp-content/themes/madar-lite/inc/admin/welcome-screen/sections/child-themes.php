			...
			<div class="madar-lite-child-theme-details">
				<?php if ( 'Madar Pro' != $current_theme['Name'] ) { ?>
					<div class="theme-details">
						...
						<a href="https://retina-theme.com/madar-pro-responsive-multipurpose-retina-ready-wordpress-theme/" class="button button-primary install right"><?php printf( __( 'Install %s now', 'madar-lite' ), '<span class="screen-reader-text">Madar Pro</span>' ); ?></a>
