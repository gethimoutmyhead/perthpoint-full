	...
	<?php endif; ?>
		...
		<div class="footer-border-bottom">	
			...
			<span class="sep"> | </span>
			<?php printf( esc_html__( 'Theme: %2$s by %1$s.', 'madar-lite' ), '<a href="https://retina-theme.com/" rel="designer">Retina Theme</a>', '<a href="http://lite.retina-theme.com/" rel="designer">Madar Lite</a>' ); ?>
				</div>
			  <div class="clearfix"></div>
			</div>
		</div>
